...
# lib/panel/{core,cert,install,management,warp,subpage,template,migrate,menu}.sh
#
...
for _panel_module in core cert install management warp subpage template migrate menu; do
